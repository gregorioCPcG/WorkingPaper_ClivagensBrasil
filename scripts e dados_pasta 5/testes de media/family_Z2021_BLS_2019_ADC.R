...
df$family <- factor(
  df$party_survey,
  levels = c(10,12,65,11,14,172,19,20,22,25,30,55,13,15,23,40,45,18,43,50),
  labels = c("Nacionalista/Democ.Cristão/Liberal","Social Democrata","Comunista/Ecológico",
             "Nacionalista/Democ.Cristão/Liberal","Nacionalista/Democ.Cristão/Liberal",
             "Nacionalista/Democ.Cristão/Liberal","Nacionalista/Democ.Cristão/Liberal",
             "Nacionalista/Democ.Cristão/Liberal","Nacionalista/Democ.Cristão/Liberal",
             "Nacionalista/Democ.Cristão/Liberal","Nacionalista/Democ.Cristão/Liberal",
             "Nacionalista/Democ.Cristão/Liberal","Social Democrata","Social Democrata",
             "Social Democrata","Social Democrata","Social Democrata","Comunista/Ecológico",
             "Comunista/Ecológico","Comunista/Ecológico")
)
