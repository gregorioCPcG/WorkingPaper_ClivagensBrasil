...
#Banco das Clivagens (2023) - Dados prim?rios
...
Dataframe$V95 <- ifelse(Dataframe$V95 <= -1, NA, Dataframe$V95) * (-1)
...
Dataframe$V197 <- (-1) * ifelse(Dataframe$`V197: Justifiable: Homosexuality` <= -1, NA, Dataframe$`V197: Justifiable: Homosexuality`)
...
Dataframe$V199 <- (-1) * ifelse(Dataframe$`V199: Justifiable: Abortion` <= -1, NA, Dataframe$`V199: Justifiable: Abortion`)
...
Dataframe$V200 <- (-1) * ifelse(Dataframe$`V200: Justifiable: Divorce` <= -1, NA, Dataframe$`V200: Justifiable: Divorce`)
...
Dataframe$V202 <- (-1) * ifelse(Dataframe$`V202: Justifiable: Homosexuality` <= -1, NA, Dataframe$`V202: Justifiable: Homosexuality`)
...
Dataframe$V204 <- (-1) * ifelse(Dataframe$`V204: Justifiable: Abortion` <= -1, NA, Dataframe$`V204: Justifiable: Abortion`)
...
Dataframe$V205 <- (-1) * ifelse(Dataframe$`V205: Justifiable: Divorce` <= -1, NA, Dataframe$`V205: Justifiable: Divorce`)
...
Dataframe$V203 <- (-1) * ifelse(Dataframe$`V203: Justifiable: Homosexuality` <= -1, NA, Dataframe$`V203: Justifiable: Homosexuality`)
...
Dataframe$Q182 <- (-1) * ifelse(Dataframe$`Q182: Justifiable: Homosexuality` <= -1, NA, Dataframe$`Q182: Justifiable: Homosexuality`)
...
Dataframe$Q184 <- (-1) * ifelse(Dataframe$`Q184: Justifiable: Abortion` <= -1, NA, Dataframe$`Q184: Justifiable: Abortion`)
...
Dataframe$Q185 <- (-1) * ifelse(Dataframe$`Q185: Justifiable: Divorce` <= -1, NA, Dataframe$`Q185: Justifiable: Divorce`)
...
Dataframe$Q193 <- (-1) * ifelse(Dataframe$`Q193: Justifiable: Having casual sex` <= -1, NA, Dataframe$`Q193: Justifiable: Having casual sex`)
...
Dataframe$Q36 <- (-1) * ifelse(Dataframe$Q36 <= -1, NA, Dataframe$Q36)
...
Dataframe$V107 <- (-1) * ifelse(Dataframe$V107 >= 50, NA, Dataframe$V107)
...
Dataframe$V102 <- (-1) * ifelse(Dataframe$V102 >= 50, NA, Dataframe$V102)
...
Dataframe$V103 <- (-1) * ifelse(Dataframe$V103 >= 50, NA, Dataframe$V103)
...
Dataframe$V105 <- (-1) * ifelse(Dataframe$V105 >= 50, NA, Dataframe$V105)
...
Dataframe$V104 <- (-1) * ifelse(Dataframe$V104 >= 50, NA, Dataframe$V104)
...
Dataframe$P47 <- (-1) * ifelse(Dataframe$P47 >= 11, NA, Dataframe$P47)
...
Dataframe$P40 <- (-1) * ifelse(Dataframe$P40 >= 11, NA, Dataframe$P40)
...
Dataframe$P43 <- (-1) * ifelse(Dataframe$P43 >= 11, NA, Dataframe$P43)
...
Dataframe$P42 <- (-1) * ifelse(Dataframe$P42 >= 11, NA, Dataframe$P42)
...
Dataframe$P41 <- (-1) * ifelse(Dataframe$P41 >= 11, NA, Dataframe$P41)
...
Dataframe$P44 <- (-1) * ifelse(Dataframe$P44 >= 11, NA, Dataframe$P44)
...
Dataframe$P45 <- (-1) * ifelse(Dataframe$P45 >= 11, NA, Dataframe$P45)
...
#Criando modelo de regress?o longitudinal
...
figurelong1 <- plot_cap(model1, condition ="anof", conf_level=.95)+
...
fa2019reg <- fa(df2019reg[,1:9], nfactors = 1, rotate = "varimax")
...
modelo1997reg <- lm(log(MR1)~R1+R2+R3+R4+R5+R6+R7+R8+R9+R10+R11, data=df1997reg)

my_confidence <- 0.95
my_digits <- 3

attach(df1997reg)
daten.plot1997 <- data.frame(MR1,R1,R2,R3,R4,R6,R8,R9,R10,R11)
detach(df1997reg)
...
summ(modelo1997reg, confint=TRUE, ci.width = my_confidence,
     digits = my_digits)

#1.2. Standardized results

summ(modelo1997reg, scale=TRUE, transform.response = TRUE, digits = my_digits)
...
ols_plot_resid_fit(modelo1997reg)`

#2.1.2. Breusch Pagan Test

ols_test_breusch_pagan(modelo1997reg)

#2.2. Normality of the residuals

#2.2.1. Histogram of residuals

ols_plot_resid_hist(modelo1997reg)

#2.2.2. QQ Plot

ols_plot_resid_qq(modelo1997reg)

#2.2.3 Shapiro-Wilk test for normality

shapiro.test(modelo1997reg$residuals)

#2.2.4 Skewness and kurtosis

skewness(modelo1997reg$residuals)
kurtosis(modelo1997reg$residuals)

#2.2.5 Significance tests for Skewness and kurtosis

agostino.test(modelo1997reg$residuals)
anscombe.test(modelo1997reg$residuals)

#2.3 Linearity

#2.3.1 Pairwise scatterplots

pairs(daten.plot1997, pch = 19, lower.panel = NULL)

#2.3.2 Rainbow test

raintest(modelo1997reg)

#2.4 Absence of strong multicollinearity

ols_vif_tol(modelo1997reg)

#2.5 Outlier diagnostics

#2.5.1 Studentized residuals

ols_plot_resid_stud(modelo1997reg)

#2.5.2 Cook's Distanz

ols_plot_cooksd_chart(modelo1997reg)

#2.5.4 Outlier & Leverage

ols_plot_resid_lev(modelo1997reg)

#2.5.4 Diffbeta

ols_plot_dfbetas(modelo1997reg)
