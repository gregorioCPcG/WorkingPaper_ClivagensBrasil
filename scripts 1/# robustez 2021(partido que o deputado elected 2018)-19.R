# robustez 2021(partido que o deputado elected 2018)-19
library(dplyr)
library(ggplot2)
library(gridExtra)
library(readr)
...
rm(bls)
table(df$wave)
df$party_elected#usar party survey no outro
...
merge$Período <- "Out 2018-2019"
summary(merge)
write.csv(merge,
          "C:/Users/grego/OneDrive/Desktop/work/Congruencia so brasil/graficos oscilacao no tempo/merelected18_19.csv")
